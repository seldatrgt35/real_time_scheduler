...
enum
{
    ...
    RTS_TRACE_TICK,
    RTS_TRACE_FATAL,
    RTS_TRACE_TIMER_INITIALIZED,
    RTS_TRACE_TIMER_STARTED,
    RTS_TRACE_TIMER_STOPPED,
    RTS_TRACE_TIMER_RESTARTED,
    RTS_TRACE_TIMER_EXPIRED,
    RTS_TRACE_TIMER_CALLBACK_BEGIN,
    RTS_TRACE_TIMER_CALLBACK_END,
    RTS_TRACE_TIMER_STALE_CALLBACK,
    RTS_TRACE_TIMER_OVERRUN,
    RTS_TRACE_SLEEP_ENTER,
    RTS_TRACE_SLEEP_EXIT,
    RTS_TRACE_SLEEP_ABORT
};
